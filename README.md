...
I am a **B.Tech Computer Science student (Cybersecurity)** graduating in **2027**.  
I am passionate about **ethical hacking, penetration testing, and secure software development**.  
I enjoy solving coding problems and building projects that combine **security, AI, and web technologies**.

- 🔐 Learning Ethical Hacking & Penetration Testing  
- 🤖 Exploring AI & Machine Learning  
- 💻 Skilled in Java, Python, MySQL & Web Development  
...
### 🌍 Predicting Animal Extinction Risk
- Built a machine learning model to predict extinction risk using environmental and climate data  
- Performed preprocessing, training, evaluation, and SHAP-based interpretation  
- Tech Used: Python, Pandas, Scikit-learn, Matplotlib  

### 📊 Project Monitoring System
- Developed a web-based system for managing academic and technical projects  
...
- AI-ML Virtual Internship – EduSkills (Google for Developers, AICTE)  
- Cybersecurity Virtual Internship – Palo Alto Networks  
- Ethical Hacking Virtual Internship – EduSkills  
